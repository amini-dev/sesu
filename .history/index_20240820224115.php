...
<body class="font-irYekan"">
    ...
    <?php get_template_part('parts/headers/header','main'); ?>
            ...
            <div class="relative">
                ...
                <div class="flex items-center justify-between sm:flex-row flex-col relative z-10">
                    <div class="w-fit bg-white dark:bg-dark-850 sm:mb-0 mb-6 pl-8 pr-8 sm:pr-0">
                        <img class="h-16 dark:bg-white" src="<?= get_template_directory_uri(); ?>/images/logo-dark.png" alt="">
                    </div>
    ...
    <script src="<?= get_template_directory_uri(); ?>/js/dependencies/alpinejs.min.js" defer></script>
    <script src="<?= get_template_directory_uri(); ?>/js/dependencies/swiper-bundle.min.js" defer></script>
    <script src="<?= get_template_directory_uri(); ?>/js/app.js" defer></script>
</body>
