...
<head>
    ...
    <link rel="stylesheet" href="<?= get_template_directory_uri(); ?>/css/dependencies/fontAwesome.css">
    <link rel="stylesheet" href="<?= get_template_directory_uri(); ?>/css/dependencies/swiper-bundle.min.css">
    ...
    <header class="fixed top-0 z-20 w-full">
        <div class="container mt-2">
            <div
                ...
                <div>
                    <img src="<?= get_template_directory_uri(); ?>/images/logo-dark.png" alt="logo"
                        class="w-12 bg-white">
                </div>
                ...
                <div class="flex gap-4 items-center">
                    <!-- Theme switcher in mobile mode -->
                    <div
                        class="mobile__theme-switcher hidden md:block bg-slate-200 text-slate-500 p-2 rounded-full dark:bg-white/5 dark:text-white">
                        <!-- sun icon -->
                        <svg fill="currentColor" class="w-6 h-6 hidden dark:inline-block" viewBox="0 0 16 16">
                            <path
                                d="M8 11a3 3 0 1 1 0-6 3 3 0 0 1 0 6m0 1a4 4 0 1 0 0-8 4 4 0 0 0 0 8M8 0a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 0m0 13a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 13m8-5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2a.5.5 0 0 1 .5.5M3 8a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2A.5.5 0 0 1 3 8m10.657-5.657a.5.5 0 0 1 0 .707l-1.414 1.415a.5.5 0 1 1-.707-.708l1.414-1.414a.5.5 0 0 1 .707 0m-9.193 9.193a.5.5 0 0 1 0 .707L3.05 13.657a.5.5 0 0 1-.707-.707l1.414-1.414a.5.5 0 0 1 .707 0m9.193 2.121a.5.5 0 0 1-.707 0l-1.414-1.414a.5.5 0 0 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .707M4.464 4.465a.5.5 0 0 1-.707 0L2.343 3.05a.5.5 0 1 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .708" />
                    ...
                    <div class="hidden md:block relative" x-data="{lang: false}">
                        <div x-on:click="lang = !lang" class="bg-slate-200 py-3 space-x-4 px-3 pl-7 text-xs rounded-xl">
                            فارسی - fa </div>
                        <ul class="absolute top-10 rounded-xl bg-slate-200 mt-2 min-w-28 text-sm" x-show="lang"
                        ...
                        <svg class="absolute top-3 left-2 pointer-events-none h-4 w-4" viewBox="0 0 16 16"
                ...
                <ul class="hidden md:flex gap-x-6 text-xs lg:text-base dark:text-slate-200">
                    <li class="relative group">
                        <a href="#"
                            ...
                            آموزش
                            <svg fill="currentColor" class="w-3 h-3" viewBox="0 0 16 16">
                                <path fill-rule="evenodd"
